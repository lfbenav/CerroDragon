...
export default function EditarReservas() {
    ...
    useEffect(() => {
        ...
        const cargarDatos = async () => {
            try {
                ...
                //   fetch(`/api/alojamientos/${reservaId}`),
                // ]);
                // 
                ...
                const reservaData: ReservaData = {
                    ...
                    cabana: 'Cabaña del Dragón',
                    fechaInicio: '20/12/2025',
                    fechaFinal: '25/12/2025',
                    personas: 4,
                    monto: 60000,
    ...
    const handleGuardar = async () => {
        ...
        try {
            ...
            // const response = await fetch(`/api/alojamientos/${reserva.id}`, {
            //   method: 'PATCH',
            //   headers: {
                    ...
                    <div className="max-w-7xl mx-auto w-full flex flex-col h-full">
                        ...
                        <div className="grid grid-row-2 grid-col-2 gap-4 mb-6">
                            <div className="items-center justify-start flex flex-row gap-4">
                                ...
                                <CuadroTexto texto={reserva.cabana} titulo="Cabaña" />
                            </div>
                            <div className="items-center justify-start flex flex-row gap-4">
                                <CuadroTexto texto={`${reserva.fechaInicio} - ${reserva.fechaFinal}`} titulo="Fechas" />
                                <CuadroTexto texto={reserva.precioPorPersona.toLocaleString()} titulo="Precio por persona por noche" />
                            </div>
                        </div>
