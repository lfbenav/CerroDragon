...
export default function AgregarAlojamiento() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            // TODO: Implementar la lógica para guardar la nueva cabaña
            ...
            setError('Error al guardar la cabaña. Por favor, intente nuevamente.');
                ...
                <main className="flex-1 flex flex-col ml-72  pt-20 px-8 min-h-0">
                    <div className="max-w-7xl mx-auto w-full flex flex-col">
                        ...
                        <div className="flex-shrink-0">
                            <h1 className="text-3xl font-bold mb-1 text-black mt-4">Agregar Alojamiento</h1>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <textarea
                                                ...
                                                placeholder="Ej. Duerma en la gran cabaña del dragón para vivir una experiencia de otro mundo"
                                                disabled={isLoading}
                                            />
                                        </div>
